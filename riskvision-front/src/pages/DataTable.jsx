                        ...
                        <tbody>
                            {data.map((asset) => (
                                <tr key={asset.id_activo} className="hover:bg-gray-100">
                                    ...
                                    <td className="border border-gray-300 px-4 py-2">{asset.version_os}</td>
                                    ...
                                    <td className="border border-gray-300 px-4 py-2 flex space-x-2">
                                        <button onClick={() => handleEdit(asset.id_activo)} className="bg-yellow-500 text-white px-3 py-1 rounded">Editar</button>
                                        <button onClick={() => handleDelete(asset.id_activo)} className="bg-red-500 text-white px-3 py-1 rounded">Eliminar</button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
